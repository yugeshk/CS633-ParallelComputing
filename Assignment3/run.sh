...
#Run script for running on the cse cluster.
echo "Running for dataset 1"
echo "Output files are saved under cse/data1"

make all
bash pinger.sh #selects hosts from the list myhosts.txt
...
mv pre_processing_time_data.txt ./cse/data1/pre_processing_time_data.txt
mv processing_time_data.txt ./cse/data1/processing_time_data.txt
mv total_time_data.txt ./cse/data1/total_time_data.txt
mv data1_time.txt ./cse/data1/data1_time.txt

#Runs for dataset2

echo "Running for dataset 2"
echo "Output files are saved under cse/data2"
...
mv pre_processing_time_data.txt ./cse/data2/pre_processing_time_data.txt
mv processing_time_data.txt ./cse/data2/processing_time_data.txt
mv total_time_data.txt ./cse/data2/total_time_data.txt
mv data2_time.txt ./cse/data2/data2_time.txt
